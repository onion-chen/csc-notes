---
title: JavaScript数据类型-Undefined、Null、Boolean、Number、String、Symbol Object
meta:
  - name: JavaScript数据类型
    content: 本节将详细介绍JavaScript数据类型 Undefined、Null、Boolean、Number、String、Symbol Object
---
# 数据类型
